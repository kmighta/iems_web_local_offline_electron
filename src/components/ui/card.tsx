...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-card text-card-foreground flex flex-col gap-3 sm:gap-6 rounded-xl border py-4 sm:py-6 shadow-sm dark:border-slate-700 dark:bg-slate-800/70 dark:border-1",
        className
      )}
      {...props}
    />
